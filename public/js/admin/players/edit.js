window.onload = () => { 
  ...
  const exitAddNew = document.querySelector('.exit-add-new-block');
  ...
  addNew.onclick = () => {
    addNewBlock.style.display = 'flex';
    addNew.parentElement.parentElement.style.display = 'none';
    sidebar.style.display = 'none';
  }
  exitAddNew.onclick = () => {
    addNewBlock.style.display = 'none';
    addNew.parentElement.parentElement.style.display = 'block';
